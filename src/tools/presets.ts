...
export function registerGenerateExecutivePresentationTool(server: McpServer): void {
  server.tool(
    ...
    async (params) => {
      ...
      if (params.themeId) executiveParams.themeId = params.themeId;
 ...
 */
export function estimateReportCards(contentText: string): number {
...
export function registerGenerateExecutiveReportTool(server: McpServer): void {
  server.tool(
    ...
    async (params) => {
      ...
      if (params.themeId) reportParams.themeId = params.themeId;

...
export const imageOptionsSchema = z
  .object({
    ...
    model: z
      ...
      .optional()
      .describe(
        "AI image model when source is 'aiGenerated', e.g. 'flux-1-quick' (2 credits) or " +
    ...
    stylePreset: z
      ...
      .optional()
      .describe(
        `Art style preset (${GAMMA_IMAGE_STYLE_PRESETS.join(" | ")}). ` +
...
export const cardOptionsSchema = z
  .object({
    dimensions: z
      ...
      .optional()
      .describe(
        `Card dimensions, and it must be valid for the chosen format. ` +
...
export const pageSchema = z.object({
  ...
  path: z
    ...
    .optional()
    .describe(
      "URL slug for this page, e.g. '/pricing'. Honored for pages after the first; " +

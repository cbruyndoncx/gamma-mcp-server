...
export function registerGetFoldersTool(server) {
    server.tool("get_folders", "Browse or search the folders you are a member of. Use the returned id as folderIds on a generation tool. You must be a member of a folder to put gammas in it.", {
